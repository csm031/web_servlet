...
public class MemberUpdateServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            //회원정보 변경이 정상적으로 이루어진 경우 session객체에 새로운 회원정보를 저장해서 메인 페이지로 이동하고
            //회원정보 변경에 실패한 경우 "시스템의 문제로 회원정보 변경이 이루어지지 않았습니다. 빠른 시일 내에 시스템을 정상화하겠습니다."
            // 를 request객체에 저장해서 회원정보 변경페이지로 이동하도록 함
